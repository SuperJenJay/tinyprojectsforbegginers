...
const markFirstEl = (e) => {
  if (isFirstImageClicked === false) {
    ...
    if (markedElementHandler.src === e.target.src) {
      ...
      markedElementHandler.removeEventListener('click',markFirstEl)
  ...
  const backUrl = 'https://img.freepik.com/free-vector/abstract-watercolor-pastel-background_87374-139.jpg'
  const urlArray = [
